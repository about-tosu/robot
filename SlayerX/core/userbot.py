...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            assistants.append(2)
            try:
                await self.two.send_message(config.LOGGER_ID, "Assistant Started @about_tosuu")
            except:
                LOGGER(__name__).error(
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("NOTHING_BOTS_SUPPORT")
                await self.one.join_chat("ABOUT_TOSUU")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("NOTHING_BOTS_SUPPORT")
                await self.one.join_chat("ABOUT_TOSUU")
            except:
                pass
            assistants.append(5)
